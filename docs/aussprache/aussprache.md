...
Im Spanischen gibt es dieselben Varianten, allerdings hängen sie dort nicht vom lautlichen Kontext ab, sondern sind jeweils typisch für bestimmte regionale oder nationale Varietäten (mehr dazu im Kapitel [Aussprachevariation](varianten.md)).

### Kein(e) Laut(ung)

Ein reiner Anfängerfehler ist es bekanntlich, das im Spanischen geschriebene, aber immer ‚stumme‘ `<h>` auszusprechen. Wir greifen es im nächsten Abschnitt zur [Orthographie](orthographie.md) wieder auf. 
